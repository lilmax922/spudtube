...
<template>
  <div class="flex items-center gap-2">
    <button
      ...
      :key="action.status"
      type="button"
      class="inline-flex h-10 items-center gap-1.5 rounded-full border border-input bg-muted px-3 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary hover:text-secondary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/20"
